...
public class MealTestData {
    ...
    public static final int MEAL_NOT_FOUND_ID = START_SEQ + 10;
    ...
    public static Meal getNew() {
        return new Meal(null, LocalDateTime.of(2020, Month.JANUARY, 5, 14, 0), "New Meal", 140 );
    }

    public static Meal getDublicate() {
        return new Meal(null, LocalDateTime.of(2020, Month.JANUARY, 5, 14, 0), "Dublicate Meal", 140 );
    }

    public static Meal getUpdated() {
        Meal updated = new Meal(meal1);
        updated.setDateTime(LocalDateTime.of(2020, Month.JANUARY, 5, 15, 0));
