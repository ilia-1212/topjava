...
public abstract class AbstractControllerTest {
    ...
    protected String getResponseString(Meal newMeal, String url, User user, ResultMatcher status) throws Exception {
    ...
    protected String getResponseString(UserTo user, String url, ResultMatcher status) throws Exception {
        return perform(MockMvcRequestBuilders.post(url)
                .contentType(MediaType.APPLICATION_JSON)
